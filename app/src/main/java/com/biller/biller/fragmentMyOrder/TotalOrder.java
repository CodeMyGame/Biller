...
import com.biller.biller.adapter.GetDetailsAdapter;
 ...
 */
public class TotalOrder extends Fragment implements View.OnClickListener,MyOrderAdapter.ClickListener {
    ...
    private com.biller.biller.adapter.GetDetailsAdapter GetDetailsAdapter;
...
//        List<MyOrderBean> filterdNames = new ArrayList<>();
//
//        //looping through existing elements
//        for (MyOrderBean s : orders) {
//            //if the existing elements contains the search input
//            if (s.getMobile().contains(text)) {
//                filterdNames.add(s);
//            }
//        }
//
//        //calling a method of the adapter class and passing the filtered list
//        sAdapter.filterList(filterdNames);
//    }
    ...
    public void dialog(){
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        GetDetailsAdapter= new GetDetailsAdapter(coll, getActivity());
        mRecyclerView.setAdapter(GetDetailsAdapter);
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (orders.size() == 0) {
                                        ...
                                        SweetAlertDialog sweetAlertDialog = new SweetAlertDialog(getActivity(), SweetAlertDialog.SUCCESS_TYPE)
                                                .setTitleText("Success!!!")
                                                .setContentText(orders.size()+" orders between these dates");
                                        sweetAlertDialog.show();
                                        Button btn =sweetAlertDialog.findViewById(R.id.confirm_button);
                                        btn.setBackgroundColor(ContextCompat.getColor(getActivity(),R.color.colorPrimary));
                                    }
