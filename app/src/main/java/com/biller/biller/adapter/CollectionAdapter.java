...
public class CollectionAdapter extends RecyclerView.Adapter<CollectionAdapter.MyViewHolder> {
    ...
    public CollectionAdapter(List<CollectionBean> orderList, Context c) {
    ...
    @Override
    public void onBindViewHolder(final CollectionAdapter.MyViewHolder holder, int position) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View view) {
            ...
            sno.getLayoutParams().width = widthPixels/3;
