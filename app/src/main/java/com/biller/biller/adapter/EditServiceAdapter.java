...
import com.biller.biller.activities.EditServices;
...
public class EditServiceAdapter extends RecyclerView.Adapter<EditServiceAdapter.MyViewHolder>  {
    ...
    public EditServiceAdapter(List<ServiceAddBean> serviceList, Context c, TextView serviceAdded) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.editLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((EditServices)context).showEditPopup(position);
            }
        });
    }
    ...
    public void removeItem(final int position) {
        ...
        Snackbar snackbar = Snackbar
                .make(EditServices.relativeLayout, deletedItem.getTitle() + " removed from list!", Snackbar.LENGTH_LONG);
